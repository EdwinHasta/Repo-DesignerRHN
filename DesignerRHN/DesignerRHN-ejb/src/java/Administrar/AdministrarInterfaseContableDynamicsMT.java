 ...
 */
@Stateful
public class AdministrarInterfaseContableDynamicsMT implements AdministrarInterfaseContableDynamicsMTInterface {
    ...
    public void ejecutarPKGCrearArchivoPlano(Date fechaIni, Date fechaFin, BigInteger proceso, String descripcionProceso, String nombreArchivo, BigInteger emplDesde, BigInteger emplHasta) {
        try {
            persistenciaInterconDynamics.ejecutarPKGCrearArchivoPlano_MAMUT(em, fechaIni, fechaFin, proceso, descripcionProceso, nombreArchivo, emplDesde, emplHasta);
        } catch (Exception e) {
    ...
    public void ejecutarPKGUbicarnuevointercon_DYNAMICS(BigInteger secuencia, Date fechaIni, Date fechaFin, BigInteger proceso, BigInteger emplDesde, BigInteger emplHasta) {
        try {
            persistenciaInterconDynamics.ejecutarPKGUbicarnuevointercon_MAMUT(em, secuencia, fechaIni, fechaFin, proceso, emplDesde, emplHasta);
        } catch (Exception e) {
