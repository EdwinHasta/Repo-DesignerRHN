...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DetallesReformasLaborales.findAll", query = "SELECT d FROM DetallesReformasLaborales d"),
    @NamedQuery(name = "DetallesReformasLaborales.findBySecuencia", query = "SELECT d FROM DetallesReformasLaborales d WHERE d.secuencia = :secuencia"),
