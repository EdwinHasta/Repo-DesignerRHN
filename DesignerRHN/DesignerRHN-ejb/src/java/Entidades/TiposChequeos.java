...
public class TiposChequeos implements Serializable {
    ...
    public TiposChequeos() {
    }

    public TiposChequeos(BigInteger secuencia) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TiposChequeos)) {
            return false;
        }
        TiposChequeos other = (TiposChequeos) object;
