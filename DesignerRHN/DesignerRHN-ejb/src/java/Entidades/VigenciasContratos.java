...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VigenciasContratos.findAll", query = "SELECT v FROM VigenciasContratos v"),
    @NamedQuery(name = "VigenciasContratos.findBySecuencia", query = "SELECT v FROM VigenciasContratos v WHERE v.secuencia = :secuencia"),
    @NamedQuery(name = "VigenciasContratos.findByFechafinal", query = "SELECT v FROM VigenciasContratos v WHERE v.fechafinal = :fechafinal"),
    @NamedQuery(name = "VigenciasContratos.findByFechainicial", query = "SELECT v FROM VigenciasContratos v WHERE v.fechainicial = :fechainicial")})
