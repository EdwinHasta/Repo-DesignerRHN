...
/**
 * Interface encargada de determinar las operaciones lógicas necesarias para la pantalla 'Comprobantes'.
 * @author betelgeuse
 */
public interface AdministrarComprobantesInterface {
     ...
     * HistoriaFormula.
     * @param fechaDesde Fecha a la cual se quiere saber, la ultima HistoriaFormula
     * hecha.
