...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'Cargos' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaCargosInterface {
    ...
    /**
     * Método encargado de modificar un Cargo de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos el Cargo que entra por parámetro.
     ...
     * @return Retorna el Cargo identificado con la secuencia dada por parámetro.
     */
     ...
     * @return Retorna una lista de Cargos. Cada objeto cargos tiene su salario incluido.
     */
