...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'ClasesAusentismos' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaClasesAusentismosInterface {
     ...
     * @param clasesAusentismos ClaseAusentismo con los cambios que se van a realizar.
     */
    public void editar(Clasesausentismos clasesAusentismos);
    /**
     * Método encargado de eliminar de la base de datos la ClaseAusentismo que entra por parámetro.
     * @param clasesAusentismos ClaseAusentismo que se quiere eliminar.
     */
    public void borrar(Clasesausentismos clasesAusentismos);
    /**
     * Método encargado de buscar todas las ClasesAusentismos existentes en la base de datos.
