...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'Conceptos' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaConceptosInterface {
    ...
    /**
     * Método encargado de modificar un Concepto de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos el Concepto que entra por parámetro.
     * @param concepto Concepto que se quiere eliminar.
     */
    public void borrar(Conceptos concepto);
    /**
     * Método encargado de buscar todos los Conceptos existentes en la base de datos.
     * @return Retorna una lista de Conceptos.
     */
    public List<Conceptos> buscarConceptos();
 
    /**
     * Método encargado de validar que el código que entra por parámetro existe en la base de datos. 
     * @param codigoConcepto Código que se quiere revisar si esta o no en la base de datos
     * @return True si el Código esta en la base de datos
     */
    public boolean verificarCodigoConcepto(BigInteger codigoConcepto);
    /**
     * Método encargado de buscar los conceptos cuyo código existe y pertence a una empresa especifica.
     ...
     * @return Retorna la lista de Conceptos cuyo cogigo concuerda con el dado y que pertenecen a la empresa con secuencia igual a la dada por parámetro
     */
     ...
     * @param secEmpresa Secuencia de la empresa a la que pertenecen los conceptos.
     * @param estado Estado de los conceptos que se quieren buscar. 'ACTIVO' o 'INACTIVO'
     * @return Retorna una lista con los conceptos que cumplen con el estado dado por parámetro.
     */
    public List<Conceptos> conceptosEmpresaActivos_Inactivos(BigInteger secEmpresa, String estado);
    /**
     * Método encargado de consultar todos los conceptos de la empresa menos los conceptos pasivos.
     * Un concepto pasivo es un estimado de cuanto le cuesta a una empresa un empleado.
     * @param secEmpresa Secuencia de la empresa a la que pertenecen los conceptos.
     * @return Retorna una lista de conceptos No pasivos que pertenecen a una empresa especifica.
     */
    public List<Conceptos> conceptosEmpresaSinPasivos(BigInteger secEmpresa);
    /**
     * Método encargado de clonar un concepto.
     * Se crea un nuevo concepto con los datos de un concepto base. 
     * Se le puede cambiar el código y la descripcion al nuevo concepto.
