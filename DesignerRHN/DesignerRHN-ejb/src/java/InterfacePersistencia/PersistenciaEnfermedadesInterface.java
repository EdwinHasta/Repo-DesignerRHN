...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'Enfermedades' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaEnfermedadesInterface {
    ...
    /**
     * Método encargado de modificar una Enfermedad de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos la Enfermedad que entra por parámetro.
     * @param enfermedades Enfermedad
     */
    public void borrar(Enfermedades enfermedades);
    /**
     * Método encargado de buscar la Enfermedad con la secuencia dada por parámetro.
     * @param secuencia Secuencia de la Enfermedad que se quiere encontrar.
     * @return Retorna la Enfermedad identificada con la secuencia dada por parámetro.
     */
    public Enfermedades buscarEnfermedad(BigInteger secuencia);
    /**
     * Método encargado de buscar todas las Enfermedades existentes en la base de datos.
