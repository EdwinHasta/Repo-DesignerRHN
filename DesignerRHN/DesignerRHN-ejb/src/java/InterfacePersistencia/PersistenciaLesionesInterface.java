...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'Lesiones' 
 * de la base de datos.
 * @author John Pineda.
 */
@Local
public interface PersistenciaLesionesInterface {
    ...
    /**
     * Método encargado de modificar una Lesion de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos la Lesion que entra por parámetro.
     ...
     * @return Retorna la Lesion identificada con la secuencia dada por parámetro.
     */
    public Lesiones buscarLesion(BigInteger secuencia);
    /**
     * Método encargado de buscar todas las Lesiones existentes en la base de datos.
     * @return Retorna una lista de Lesiones.
     */
    public List<Lesiones> buscarLesiones();
    /**
     * Método encargado de contar los DetallesLicensias que están asociados a una Lesion específica.
     * @param secuencia Secuencia de la Lesion.
     * @return Retorna la cantidad de DetallesLicensias cuya Lesion tiene como secuencia el valor dado por parámetro.
     */
    public BigInteger contadorDetallesLicensias(BigInteger secuencia);
    /**
     * Método encargado de contar los SOAccidentesMedicos que están asociados a una Lesion específica.
     * @param secuencia Secuencia de la Lesion.
     * @return Retorna la cantidad de SOAccidentesMedicos cuya Lesion tiene como secuencia el valor dado por parámetro.
     */
