...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'MotivosDefinitivas' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaMotivosDefinitivasInterface {
     ...
     * @param motivosDefinitivas MotivoDefinitiva con los cambios que se van a realizar.
     */
    public void editar(Motivosdefinitivas motivosDefinitivas);
    /**
     * Método encargado de eliminar de la base de datos el MotivoDefinitiva que entra por parámetro.
     * @param motivosDefinitivas MotivoDefinitiva que se quiere eliminar.
     */
    public void borrar(Motivosdefinitivas motivosDefinitivas);
    /**
     * Método encargado de buscar todos los Motivosdefinitivas existentes en la base de datos, ordenados por código.
