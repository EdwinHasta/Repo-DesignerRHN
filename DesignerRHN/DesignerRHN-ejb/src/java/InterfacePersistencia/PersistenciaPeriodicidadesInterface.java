...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'Periodicidades' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaPeriodicidadesInterface {
    ...
    /**
     * Método encargado de modificar una Periodicidad de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos la Periodicidad que entra por parámetro.
     * @param periodicidades Periodicidad que se quiere eliminar.
     */
    public void borrar(Periodicidades periodicidades);
    /**
     * Método encargado de buscar la Periodicidad con la secuencia dada por parámetro.
     * @param secuencia Secuencia de la Periodicidad que se quiere encontrar.
     * @return Retorna la Periodicidad identificada con la secuencia dada por parámetro.
     */
    public Periodicidades buscarPeriodicidades(BigInteger secuencia);
    /**
     * Método encargado de buscar todas las Periodicidades existentes en la base de datos.
