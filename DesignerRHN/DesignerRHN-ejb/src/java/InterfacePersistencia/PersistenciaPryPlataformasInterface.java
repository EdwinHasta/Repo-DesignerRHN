...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'PryPlataformas' 
 * de la base de datos.
 * @author betelgeuse
 */
public interface PersistenciaPryPlataformasInterface {
    ...
    /**
     * Método encargado de modificar un PryPlataforma de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos el PryPlataforma que entra por parámetro.
     * @param plataformas PryPlataforma que se quiere eliminar.
     */
    public void borrar(PryPlataformas plataformas);
    /**
     * Método encargado de buscar todos los PryPlataformas existentes en la base de datos.
     * @return Retorna una lista de PryPlataformas.
     */
    public List<PryPlataformas> buscarPryPlataformas();
    /**
     * Método encargado de buscar el PryPlataforma con la secuencia dada por parámetro.
     * @param secuencia Secuencia del PryPlataforma que se quiere encontrar.
     * @return Retorna el PryPlataforma identificado con la secuencia dada por parámetro.
     */
