...
/**
 * Interface encargada de determinar las operaciones que se realizan sobre la tabla 'TiposDescansos' 
 * de la base de datos.
 * @author AndresPineda
 */
public interface PersistenciaTiposDescansosInterface {    
    ...
    /**
     * Método encargado de modificar un TipoDescanso de la base de datos.
    ...
    /**
     * Método encargado de eliminar de la base de datos el TipoDescanso que entra por parámetro.
     * @param tiposDescansos TipoDescanso que se quiere eliminar.
     */
    public void borrar(TiposDescansos tiposDescansos);    
    /**
     * Método encargado de buscar todos los TiposDescansos existentes en la base de datos.
     * @return Retorna una lista de TiposDescansos.
     */
    public List<TiposDescansos> buscarTiposDescansos();
    /**
     * Método encargado de buscar el TipoDescanso con la secuencia dada por parámetro.
     * @param secuencia Secuencia del TipoDescanso que se quiere encontrar.
     * @return Retorna el TipoDescanso identificado con la secuencia dada por parámetro.
     */
