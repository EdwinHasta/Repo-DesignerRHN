...
import InterfaceAdministrar.AdministrarInterfaseContableDynamicsPBInterface;
...
@ManagedBean
@SessionScoped
public class ControlInterfaseContableDynamicsPB implements Serializable {

    @EJB
    AdministrarInterfaseContableDynamicsPBInterface administrarInterfaseDynamicsPB;
    @EJB
    ...
    public ControlInterfaseContableDynamicsPB() {
        msnPaso1 = "";
        totalCGenerado = 0;
        totalDGenerado = 0;
        totalDInter = 0;
    ...
    public void inicializarAdministrador() {
        try {
            ...
            administrarInterfaseDynamicsPB.obtenerConexion(ses.getId());
    ...
    public void inicioCerrarPeriodoContable() {
        try {
            RequestContext context = RequestContext.getCurrentInstance();
            int contador = administrarInterfaseDynamicsPB.contarProcesosContabilizadosInterconDynamics(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
            if (contador != -1) {
                if (contador == 0) {
    ...
    public void finCerrarPeriodoContable() {
        try {
            RequestContext context = RequestContext.getCurrentInstance();
            guardadoGeneral();
            administrarInterfaseDynamicsPB.cerrarProcesoContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia(), parametroContableActual.getCodigoempleadodesde(), parametroContableActual.getCodigoempleadohasta());
            listaGenerados = null;
            if (listaGenerados == null) {
                listaGenerados = administrarInterfaseDynamicsPB.obtenerSolucionesNodosParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                if (listaGenerados != null) {
            ...
            if (listaInterconDynamics == null) {
                listaInterconDynamics = administrarInterfaseDynamicsPB.obtenerInterconDynamicsParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                if (listaInterconDynamics != null) {
    ...
    public void actionBtnGenerarPlano() {
        try {
            guardadoGeneral();
            String descripcionProceso = administrarInterfaseDynamicsPB.obtenerDescripcionProcesoArchivo(parametroContableActual.getProceso().getSecuencia());
            String nombreArchivo = "Interfase_DYNAMICS_" + descripcionProceso;
            administrarInterfaseDynamicsPB.ejecutarPKGCrearArchivoPlano(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia(), descripcionProceso, nombreArchivo, parametroContableActual.getCodigoempleadodesde(), parametroContableActual.getCodigoempleadohasta());
    ...
    public void actionBtnRecontabilizar() {
        Integer contador = administrarInterfaseDynamicsPB.conteoContabilizacionesDynamics(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
        if (contador != null) {
            if (contador != 0) {
    ...
    public void finalizarProcesoRecontabilizacion() {
        try {
            guardadoGeneral();
            administrarInterfaseDynamicsPB.ejecutarPKGRecontabilizar(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
        } catch (Exception e) {
    ...
    public void actionBtnDeshacer() {
        try {
            RequestContext context = RequestContext.getCurrentInstance();
            guardadoGeneral();
            administrarInterfaseDynamicsPB.actualizarFlagContabilizacionDeshacerDynamics(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia(), parametroContableActual.getCodigoempleadodesde(), parametroContableActual.getCodigoempleadohasta());
            administrarInterfaseDynamicsPB.deleteInterconDynamics(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia(), parametroContableActual.getCodigoempleadodesde(), parametroContableActual.getCodigoempleadohasta());
            administrarInterfaseDynamicsPB.actualizarFlagContabilizacionDeshacerDynamics_NOT_EXITS(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia(), parametroContableActual.getCodigoempleadodesde(), parametroContableActual.getCodigoempleadohasta());
            listaGenerados = null;
            if (listaGenerados == null) {
                listaGenerados = administrarInterfaseDynamicsPB.obtenerSolucionesNodosParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                if (listaGenerados != null) {
    ...
    public void actionBtnEnviar() {
        Date fechaDesde = administrarInterfaseDynamicsPB.buscarFechaDesdeVWActualesFechas();
        Date fechaHasta = administrarInterfaseDynamicsPB.buscarFechaHastaVWActualesFechas();
        RequestContext context = RequestContext.getCurrentInstance();
    ...
    public void anularComprobantesCerrados() {
        try {
            guardadoGeneral();
            administrarInterfaseDynamicsPB.anularComprobantesCerrados(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia());
    ...
    public void validarFechasProcesoActualizar() {
        Date fechaContabilizacion = administrarInterfaseDynamicsPB.obtenerFechaMaxContabilizaciones();
        Date fechaInterconTotal = administrarInterfaseDynamicsPB.obtenerFechaMaxInterconDynamics();
        DateFormat df = DateFormat.getDateInstance(DateFormat.LONG);
        RequestContext context = RequestContext.getCurrentInstance();
    ...
    public boolean validarFechasParametros() {
        ...
        ParametrosEstructuras parametroLiquidacion = administrarInterfaseDynamicsPB.parametrosLiquidacion();
    ...
    public void guardarCambiosParametro() {
        ...
        try {
            if (modificacionParametro == true) {
                administrarInterfaseDynamicsPB.modificarParametroContable(parametroContableActual);
                modificacionParametro = false;
            }
            if (!listParametrosContablesBorrar.isEmpty()) {
                for (int i = 0; i < listParametrosContablesBorrar.size(); i++) {
                    administrarInterfaseDynamicsPB.borrarParametroContable(listParametrosContablesBorrar);
                }
        ...
        try {
            if (nuevoParametroContable.getEmpresaRegistro().getSecuencia() != null && nuevoParametroContable.getFechafinalcontabilizacion() != null && nuevoParametroContable.getFechainicialcontabilizacion() != null) {
                ...
                if (validar == true) {
                    ...
                    administrarInterfaseDynamicsPB.crearParametroContable(nuevoParametroContable);
                    nuevoParametroContable = new ParametrosContables();
                    activarAgregar = true;
                    activarOtros = false;
                    listaParametrosContables = null;
    ...
    public ActualUsuario getActualUsuarioBD() {
        if (actualUsuarioBD == null) {
            actualUsuarioBD = administrarInterfaseDynamicsPB.obtenerActualUsuario();
        }
    ...
    public List<Empresas> getLovEmpresas() {
        lovEmpresas = administrarInterfaseDynamicsPB.lovEmpresas();
        return lovEmpresas;
    }
    ...
    public List<Procesos> getLovProcesos() {
        lovProcesos = administrarInterfaseDynamicsPB.lovProcesos();
        return lovProcesos;
    }
    ...
    public List<ParametrosContables> getListaParametrosContables() {
        if (listaParametrosContables == null) {
            ...
            if (actualUsuarioBD.getSecuencia() != null) {
                listaParametrosContables = administrarInterfaseDynamicsPB.obtenerParametrosContablesUsuarioBD(actualUsuarioBD.getAlias());
            }
            if (listaParametrosContables != null) {
                int tam = listaParametrosContables.size();
                if (tam > 0) {
    ...
    public List<Empleados> getLovEmpleados() {
        lovEmpleados = administrarInterfaseDynamicsPB.buscarEmpleadosEmpresa();
        return lovEmpleados;
    }
