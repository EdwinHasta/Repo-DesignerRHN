...
public class ControlInterfaseContableDynamicsRO implements Serializable {
    ...
    public void actionBtnGenerarPlano() {
        try {
            ...
            String nombreArchivo = "Interfase_Total_" + descripcionProceso;
