...
@ManagedBean
@SessionScoped
public class ControlInterfaseContableSapBOVCA implements Serializable {

    @EJB
    AdministrarInterfaseContableSapBOVCAInterface administrarInterfaseContableSapBOVCA;
    @EJB
    ...
    public void inicializarAdministrador() {
        try {
            ...
            administrarInterfaseContableSapBOVCA.obtenerConexion(ses.getId());
    ...
    public boolean validarFechasParametros() {
        ...
        ParametrosEstructuras parametroLiquidacion = administrarInterfaseContableSapBOVCA.parametrosLiquidacion();
            ...
            if (validarFechasParametros() == true) {
                if (parametroContableActual.getFechafinalcontabilizacion() != null
                    ...
                    if (listaGenerados == null) {
                        listaGenerados = administrarInterfaseContableSapBOVCA.obtenerSolucionesNodosParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                        if (listaGenerados != null) {
                    ...
                    if (listaInterconSapBO == null) {
                        listaInterconSapBO = administrarInterfaseContableSapBOVCA.obtenerInterconSapBOVCAParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                        if (listaInterconSapBO != null) {
                    ...
                    Date fechaContable = administrarInterfaseContableSapBOVCA.obtenerMaxFechaContabilizaciones();
                    Date fechaInter = administrarInterfaseContableSapBOVCA.obtenerMaxFechaIntercoSapBO();
    ...
    public void actionBtnRecontabilizar() {
        Integer contador = administrarInterfaseContableSapBOVCA.obtenerContadorFlagGeneradoFechasSAP(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
        if (contador != null) {
            if (contador != 0) {
    ...
    public void finalizarProcesoRecontabilizacion() {
        try {
            guardadoGeneral();
            administrarInterfaseContableSapBOVCA.ejecutarPKGRecontabilizacion(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
        } catch (Exception e) {
    ...
    public void anularComprobantesCerrados() {
        try {
            guardadoGeneral();
            administrarInterfaseContableSapBOVCA.actualizarFlagProcesoAnularInterfaseContableSAPBOVCA(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
    ...
    public void actionBtnEnviar() {
        Date fechaDesde = administrarInterfaseContableSapBOVCA.buscarFechaDesdeVWActualesFechas();
        Date fechaHasta = administrarInterfaseContableSapBOVCA.buscarFechaHastaVWActualesFechas();
        RequestContext context = RequestContext.getCurrentInstance();
        if (fechaDesde != null && fechaHasta != null) {
            if ((fechaDesde.before(parametroContableActual.getFechainicialcontabilizacion()) && fechaHasta.after(parametroContableActual.getFechafinalcontabilizacion()))
                ...
                if (parametroContableActual.getEmpresaRegistro().getSecuencia() != null
                        ...
                        && parametroContableActual.getFechainicialcontabilizacion() != null) {
                    guardadoGeneral();
                    administrarInterfaseContableSapBOVCA.ejeuctarPKGUbicarnuevointercon_SAPBO_VCA(parametroContableActual.getSecuencia(), parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia());
                    listaGenerados = null;
                    if (listaGenerados == null) {
                        listaGenerados = administrarInterfaseContableSapBOVCA.obtenerSolucionesNodosParametroContable(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
                        if (listaGenerados != null) {
    ...
    public void actionBtnDeshacer() {
        try {
            ...
            administrarInterfaseContableSapBOVCA.cambiarFlagInterconContableSAPBOVCA(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia());
            administrarInterfaseContableSapBOVCA.ejecutarDeleteInterconSAP(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia());
    ...
    public void cerrarProcesoLiquidacion() {
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            guardadoGeneral();
            administrarInterfaseContableSapBOVCA.cerrarProcesoLiquidacion(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion(), parametroContableActual.getProceso().getSecuencia());
    ...
    public void guardarCambiosParametro() {
        ...
        try {
            if (modificacionParametro == true) {
                administrarInterfaseContableSapBOVCA.modificarParametroContable(parametroContableActual);
                modificacionParametro = false;
            }
            if (!listParametrosContablesBorrar.isEmpty()) {
                for (int i = 0; i < listParametrosContablesBorrar.size(); i++) {
                    administrarInterfaseContableSapBOVCA.borrarParametroContable(listParametrosContablesBorrar);
                }
        ...
        try {
            if (nuevoParametroContable.getEmpresaRegistro().getSecuencia() != null && nuevoParametroContable.getFechafinalcontabilizacion() != null && nuevoParametroContable.getFechainicialcontabilizacion() != null) {
                ...
                if (validar == true) {
                    ...
                    administrarInterfaseContableSapBOVCA.crearParametroContable(nuevoParametroContable);
                    nuevoParametroContable = new ParametrosContables();
                    activarAgregar = true;
                    activarOtros = false;
                    listaParametrosContables = null;
    ...
    public void exportPDF_I() throws IOException {
        ...
        FacesContext context = c;
        Exporter exporter = new ExportarPDF();
        exporter.export(context, tabla, "InterconSAPBOVCA_PDF", false, false, "UTF-8", null, null);
        context.responseComplete();
        indexIntercon = -1;
    }
    ...
    public void exportXLS_I() throws IOException {
        ...
        FacesContext context = c;
        Exporter exporter = new ExportarXLS();
        exporter.export(context, tabla, "InterconSAPBOVCA_XLS", false, false, "UTF-8", null, null);
        context.responseComplete();
        indexIntercon = -1;
    }
    ...
    public void inicioCerrarPeriodoContable() {
        try {
            RequestContext context = RequestContext.getCurrentInstance();
            int contador = administrarInterfaseContableSapBOVCA.contarProcesosContabilizadosInterconSAPBO(parametroContableActual.getFechainicialcontabilizacion(), parametroContableActual.getFechafinalcontabilizacion());
            if (contador != -1) {
                if (contador == 0) {
    ...
    public void descargarArchivoFTP() throws IOException {
        try {
            usuarioInterfaseContabilizacion = administrarInterfaseContableSapBOVCA.obtenerUsuarioInterfaseContabilizacion();
            conectarAlFTP();
    ...
    public ActualUsuario getActualUsuarioBD() {
        if (actualUsuarioBD == null) {
            actualUsuarioBD = administrarInterfaseContableSapBOVCA.obtenerActualUsuario();
        }
    ...
    public List<ParametrosContables> getListaParametrosContables() {
        if (listaParametrosContables == null) {
            getActualUsuarioBD();
            if (actualUsuarioBD != null) {
                listaParametrosContables = administrarInterfaseContableSapBOVCA.obtenerParametrosContablesUsuarioBD(actualUsuarioBD.getAlias());
            }
            if (listaParametrosContables != null) {
                int tam = listaParametrosContables.size();
                if (tam > 0) {
    ...
    public List<Empresas> getLovEmpresas() {
        lovEmpresas = administrarInterfaseContableSapBOVCA.lovEmpresas();
        return lovEmpresas;
    }
    ...
    public List<Procesos> getLovProcesos() {
        lovProcesos = administrarInterfaseContableSapBOVCA.lovProcesos();
        return lovProcesos;
    }
