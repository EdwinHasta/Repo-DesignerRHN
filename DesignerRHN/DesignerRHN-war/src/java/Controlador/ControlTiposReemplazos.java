...
public class ControlTiposReemplazos implements Serializable {
    ...
    public void verificarBorrado() {
        ...
        try {
            if (tipoLista == 0) {
                verificarBorrandoEncargaturas = administrarTiposReemplazos.verificarBorradoEncargaturas(listTiposReemplazos.get(index).getSecuencia());
                verificarBorradoProgramacionesTiempos = administrarTiposReemplazos.verificarBorradoProgramacionesTiempos(listTiposReemplazos.get(index).getSecuencia());
                verificarBorradoReemplazos = administrarTiposReemplazos.verificarBorradoReemplazos(listTiposReemplazos.get(index).getSecuencia());
            } else {
                verificarBorrandoEncargaturas = administrarTiposReemplazos.verificarBorradoEncargaturas(filtrarTiposReemplazos.get(index).getSecuencia());
                verificarBorradoProgramacionesTiempos = administrarTiposReemplazos.verificarBorradoProgramacionesTiempos(filtrarTiposReemplazos.get(index).getSecuencia());
                verificarBorradoReemplazos = administrarTiposReemplazos.verificarBorradoReemplazos(filtrarTiposReemplazos.get(index).getSecuencia());
    ...
    public void guardarTipoReemplazo() {
        ...
        if (guardado == false) {
            ...
            if (!crearTiposReemplazos.isEmpty()) {
                for (int i = 0; i < crearTiposReemplazos.size(); i++) {
    ...
    public List<TiposReemplazos> getListTiposReemplazos() {
        if (listTiposReemplazos == null) {
            listTiposReemplazos = administrarTiposReemplazos.mostrarTiposReemplazos();
        }
