...
public class ControlVigenciaJornada implements Serializable {
        ...
        if (confirmarCambio.equalsIgnoreCase("NOMBREJORNADA")) {
            ...
            if (!valorConfirmar.isEmpty()) {
                if (tipoLista == 0) {
                    ...
                    filtrarVJ.get(indice).getTipodescanso().setDescripcion(tipoDescanso);
                }
            ...
            if ((cambiosDinero == false) && (cambiosTiempo == false)) {
                ...
                if (tipoLista == 1) {
                    ...
                    if (cualCelda == 1) {
                        ...
                        tipoDescanso = filtrarVJ.get(index).getTipodescanso().getDescripcion();
                    }
                }
                listVigenciasCompensacionesTiempo = null;
    ...
    public void guardadoGeneral() {
        if (cambiosJornada == true) {
            guardarCambiosVJ();
        }
        if (cambiosTiempo == true) {
            guardarCambiosVCT();
        }
        if (cambiosDinero == true) {
            guardarCambiosVCD();
        }
        guardado = true;
        RequestContext context = RequestContext.getCurrentInstance();
